...
class AuthController(
    ...
    fun register(@RequestBody @Valid request: RegisterRequestDto, servletResponse: HttpServletResponse): AuthResponse =
        authService.register(request, servletResponse)

    @PostMapping("/login")
    @ResponseStatus(HttpStatus.OK)
    fun login(@RequestBody @Valid request: LoginRequestDto, servletResponse: HttpServletResponse): AuthResponse =
